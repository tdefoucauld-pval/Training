...
//--> thenDetails			_NEVER
		...
		/* 	
			...
			FR: Attention, si filtre d'une regle en cours, l'attribut ne sera pris en compte que si l'entr̩e
			dans la r̬gle a ̩t̩ trac̩ afin que cette trace n'apparaisse pas comme un cheveu dans la soupe
